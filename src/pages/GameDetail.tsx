    ...
    <div className={styles.page}>
      ...
      <div className={styles.body}>
        <div className={styles.metaRow}>
          ...
          {game.trending && <Chip static tone="live">Trending</Chip>}
        ...
        <div className={styles.stats}>
          <div className={styles.stat}><Icon name="star" variant="solid" size={18} /><span className="num">{game.rating.toFixed(1)}</span><small>Rating</small></div>
        ...
        <p className={styles.desc}>
          ...
          leaderboards, and turn your best runs into airtime and ZiG cash rewards.
        </p>
